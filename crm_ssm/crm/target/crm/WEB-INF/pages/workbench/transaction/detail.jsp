...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<c:forEach items="${stageList}" var="stage">
			<%-- 如果stage就是交当前易所处阶段，则图标显示为 glyphicon-map-marker,颜色显示为绿色 --%>
			...
			<%-- 如果stage就是交当前易所处阶段之前，则图标显示为 glyphicon-ok-circle ,颜色显示为绿色 --%>
			...
			<%-- 如果stage就是交当前易所处阶段之后，则图标显示为 glyphicon-record ,颜色显示为黑色 --%>
			<c:if test="${tran.orderNo < stage.orderNo}">
	...
	<div style="position: relative; top: 100px; left: 40px;">
		...
		<div class="remarkDiv" id="div_${r.id}" style="height: 60px;">
			...
			<div style="position: relative; top: -40px; left: 40px;" >
				<h5>${r.nextContact}</h5>
				<font color="gray">交易</font> <font color="gray">-</font> <b>${tran.name}</b> <small style="color: gray;"> ${r.editFlag == '0' ? r.createTime : r.editTime} 由 ${r.editFlag == '0' ? r.createBy : r.editBy}${r.editFlag == '0' ? '创建' : '修改'}</small>
