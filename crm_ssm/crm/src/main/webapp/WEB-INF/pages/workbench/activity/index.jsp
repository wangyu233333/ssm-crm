    ...
    <script type="text/javascript">
        ...
        $(function () {
                    ...
                    正则表达式：
                        语法通则：
                            ...
                            5）特色符号：
                                ...
                                \W:匹配非字符，除字母，数字，下划线之外的字符

                                *：匹配0次或多次   +：匹配1次或多次  ？：匹配0次或者1次
                 */
                var regExp = /^(([1-9]\d*)|0)$/;
                if (!regExp.test(cost)) {
                    alert("成本只能为非负整数");
            ...
            $(".myDate").datetimepicker({
                ...
                minView: 'month',	//可以选择的最新视图
                initialDate: new Date(),	//	初始化显示的日期
                autoclose: true,	//	设置选择完成日期或时间之后，日历是否自动关闭
                todayBtn: true,	//	设置是否显示“经今天”按钮
            ...
            $("#exportActivityXzBtn").click(function () {
                ...
                ids = ids.substr(0, ids.length - 1);
                window.location.href = "workbench/activity/exportActivityById.do?" + ids;
            });
            ...
            $("#importActivityBtn").click(function () {
                ...
                //  FormData 是 Ajax提供的接口，可以模拟键值对向后台提交参数
                ...
                $.ajax({
                    ...
                    data: formData,
                    processData: false,  //  设置ajax向后台提交参数之前，是否把参数同义转换成字符串，：true----是，false----不是    默认是 true
                    contentType: false,   //  设置ajax向后台提交参数之前，是否把所有的参数统一按urlencoded编码， true---是，false---不是，默认为true
                    type: 'post',
                    dataType: 'json',
                    success: function (data) {
                        if (data.code == "1") {
