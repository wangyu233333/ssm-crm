...
public class ActivityServiceImpl implements ActivityService {
    ...
    @Override
    public List<Activity> queryActivityByConditionForPager(Map<String, Object> map) {
        return activityMapper.selectActivityConditionForPage(map);
    }
    ...
    @Override
    public Activity queryActivityFoeDetailById(String id) {
